        ...
        <header className="sticky top-0 z-50 w-full border-b border-gray-100 bg-white">
            <div className="container flex items-center justify-between h-20">
                ...
                <div className="flex items-center gap-4">
                    <button className="bg-secondary text-white px-8 py-2.5 rounded-full font-semibold hover:bg-primary transition-all shadow-lg shadow-secondary/20 active:scale-95">
                        Contact us
                    </button>
                </div>
            </div>
